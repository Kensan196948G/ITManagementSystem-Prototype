...
from packages.backend.schemas.incident import IncidentCreateSchema, IncidentUpdateSchema, IncidentResponseSchema
...
def list_incidents():
    ...
    response = [IncidentResponseSchema.from_orm(incident).dict() for incident in incidents]
