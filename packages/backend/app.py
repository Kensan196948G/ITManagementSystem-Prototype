...
def get_incidents():
    ...
    return jsonify({"incidents": sample_incidents, "total": len(sample_incidents)})
...
def create_incident():
    ...
    return (
        jsonify({"message": "Incident created successfully", "incident": new_incident}),
        201,
    )
...
def get_problems():
    ...
    return jsonify({"problems": sample_problems, "total": len(sample_problems)})
...
def get_users():
    ...
    return jsonify({"users": sample_users, "total": len(sample_users)})
...
def test_database():
    ...
    try:
        ...
        return jsonify(
            {"database": "connected", "message": "Database connection successful"}
        )
