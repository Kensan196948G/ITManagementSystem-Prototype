...
class User(Base):
    ...
    assigned_problems = relationship(
        "Problem", foreign_keys="Problem.assignee_id", back_populates="assignee"
    )
    reported_problems = relationship(
        "Problem", foreign_keys="Problem.reporter_id", back_populates="reporter"
    )

    # 変更管理関連
    requested_changes = relationship(
        "Change", foreign_keys="Change.requester_id", back_populates="requester"
    )
    approved_changes = relationship(
        "Change", foreign_keys="Change.approver_id", back_populates="approver"
    )
